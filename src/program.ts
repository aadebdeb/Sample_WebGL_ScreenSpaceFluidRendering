function createProgram(gl: WebGL2RenderingContext, vertShader: WebGLShader, fragShader: WebGLShader, varyings?: string[]): WebGLProgram {
...
export class Program {
  ...
  constructor(gl: WebGL2RenderingContext, vertShader: WebGLShader, fragShader: WebGLShader, uniformNames: string[], varyings?: string[]) {
    this.program = createProgram(gl, vertShader, fragShader, varyings);
